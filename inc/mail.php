...
function send_mail() {
	...
	if ( $_POST['form_name'] == 'Заявка' && ! wp_verify_nonce( $_POST['welcome-callback-nonce'], $_POST['form_name'] ) ) exit;
	...
	if ( $_POST['form_name'] == 'Викторина' && ! wp_verify_nonce( $_POST['quiz-form-nonce'], $_POST['form_name'] ) ) exit;
	...
	$mail .= isset( $_POST['quiz'] ) ? strip_tags( $_POST['quiz'], '<br>' ) . "<br/>" : '';
